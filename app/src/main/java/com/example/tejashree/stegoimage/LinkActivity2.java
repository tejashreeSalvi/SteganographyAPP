...
public class LinkActivity2 extends AppCompatActivity implements TextDecodingCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button playVideo = findViewById(R.id.btn_play_video);
        ...
        decode_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (filepath != null) {
                    ...
                    TextDecoding textDecoding = new TextDecoding(LinkActivity2.this, LinkActivity2.this);
        ...
        if (result != null) {
            if (!result.isDecoded())
                ...
                if (!result.isSecretKeyWrong()) {
                    ...
                    watchYoutubeVideo(getApplicationContext(),result.getMessage());
                } else {
